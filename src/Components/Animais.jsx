  ...
  return (
    <section id="Animais" className="py-16 px-6 bg-purple-200 text-center">
      ...
      <div className="
        ...
        gap-8 max-w-6xl mx-auto justify-items-center
      ">
        ...
        {displayedPets.map((pet, i) => (
          ...
          >
            <Link
              to="/catalogo"
              className="bg-white rounded-2xl shadow-lg overflow-hidden transform hover:scale-105
                         transition-all duration-300 flex flex-col text-center w-full max-w-sm cursor-pointer"
            >
              <img
                src={pet.img}
                alt={pet.name}
              ...
              <div className="p-6 flex flex-col items-center justify-between flex-grow">
                ...
                <button
                  className="mt-4 bg-purple-600 text-white font-semibold px-6 py-2 rounded-xl
                             shadow-lg hover:bg-purple-700 transition-all duration-300 cursor-pointer"
                >
                  Quero Adotar
                </button>
              </div>
      ...
      <div className="flex justify-center gap-4 mt-12">
        ...
        {visiblePets < pets.length && (
          <button
            data-aos="fade-up"
            className="bg-purple-600 text-white font-semibold px-6 py-3 rounded-xl shadow-lg 
        ...
        {visiblePets > initialPets && (
          <button
            data-aos="fade-up"
            data-aos-delay="150"
            className="bg-gray-600 text-white font-semibold px-6 py-3 rounded-xl shadow-lg
